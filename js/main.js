...
function visualize(cells, c) {
  ...
  cells.forEach(function(cell) {
    c.beginPath()
    c.arc(cell.pos[0], cell.pos[1], 6, 0, 2 * Math.PI)
    c.fill()
...
cells.forEach(function(cell) {
  //cell.speed = [ (cell.pos[1] - centroid[1]) * 0.02, (cell.pos[0] - centroid[0]) * 0.02]

  cell.speed = [(centroid[0] - cell.pos[0]) * 0.02, (centroid[1] - cell.pos[1]) * 0.02]
})
